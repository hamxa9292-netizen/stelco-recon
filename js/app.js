...
const FILE_SLOTS = {
  male: [
    ...
    { key: "misc_open_pdf",   label: "MISC Opening Summary",      icon: "📂", desc: "MISC Bills Debtors Summary (opening)",   required: true  },
    { key: "misc_close_pdf",  label: "MISC Closing Summary",      icon: "📁", desc: "MISC Bills Debtors Summary (closing)",   required: true  },
    { key: "misc_sales_pdf",  label: "MISC Sales Report",         icon: "📊", desc: "MISC Bills Sales Report",               required: true  },
